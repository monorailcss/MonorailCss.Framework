...
/// <summary>
/// Handles mask conic gradient to position utilities.
/// Handles: mask-conic-to-0%, mask-conic-to-50%, mask-conic-to-100%, etc.
/// </summary>
internal class MaskConicToUtility : BaseFunctionalUtility
{
    protected override string[] Patterns => ["mask-conic-to"];
    ...
    protected override ImmutableList<AstNode> GenerateDeclarations(string pattern, string value, bool important)
    {
        ...
        // Add the to position
        declarations.Add(new Declaration("--tw-mask-conic-to-position", value, important));
