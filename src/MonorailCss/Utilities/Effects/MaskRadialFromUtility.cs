...
/// <summary>
/// Handles mask radial gradient from position utilities.
/// Handles: mask-radial-from-0%, mask-radial-from-50%, mask-radial-from-100%, etc.
/// </summary>
internal class MaskRadialFromUtility : BaseFunctionalUtility
{
    protected override string[] Patterns => ["mask-radial-from"];
    ...
    protected override ImmutableList<AstNode> GenerateDeclarations(string pattern, string value, bool important)
    {
        ...
        declarations.Add(new Declaration("--tw-mask-radial-from-position", value, important));
