...
/// <summary>
/// Handles mask linear gradient from position utilities.
/// Handles: mask-linear-from-0%, mask-linear-from-50%, mask-linear-from-100%, etc.
/// </summary>
internal class MaskLinearFromUtility : BaseFunctionalUtility
{
    protected override string[] Patterns => ["mask-linear-from"];
    ...
    protected override ImmutableList<AstNode> GenerateDeclarations(string pattern, string value, bool important)
    {
        ...
        declarations.Add(new Declaration("--tw-mask-linear-from-position", value, important));
