...
MonorailCss is a JIT CSS compiler that aims to be a Tailwind CSS 4.3 compatible CSS engine written in .NET. It processes utility class names and generates optimized CSS output.
